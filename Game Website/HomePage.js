...
function selectEdition(name, price) {
    ...
    // Enable the Add to Cart button now that an edition has been selected
...
function addSelectedEdition() {
    ...
    // If the edition is already in the cart, increase its quantity
    if (existingProduct) {
        ...
        // If the edition is not already in the cart, add it as a new product
        cart.push({
